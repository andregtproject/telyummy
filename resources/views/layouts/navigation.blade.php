    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto no-scrollbar">
        ...
        <div>
            ...
            <a href="{{ route('dashboard') }}" 
               class="flex items-center gap-3 px-4 py-3.5 rounded-2xl font-semibold transition-all duration-200 group relative overflow-hidden
               {{ request()->routeIs('dashboard') ? 'bg-red-600 text-white shadow-lg shadow-red-500/30' : 'text-slate-500 hover:bg-red-50 hover:text-red-600' }}">
