...
<head>
    ...
    <title>Reset Password - Kantin Telyu</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    <div class="glass w-full max-w-md p-8 rounded-[2.5rem] shadow-2xl shadow-red-500/10 border border-white/50">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 mt-2 text-sm font-medium">Silakan masukkan password baru Anda.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus 
                    class="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all shadow-sm opacity-70 cursor-not-allowed" readonly>
            </div>
