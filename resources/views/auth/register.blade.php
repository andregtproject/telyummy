...
<body class="bg-gray-50 text-slate-800 antialiased selection:bg-red-500 selection:text-white">
    ...
    <div class="min-h-screen flex items-center justify-center p-4 py-12 bg-white bg-opacity-10">
        <div x-data="{ role: 'pembeli' }" class="glass w-full max-w-2xl p-8 rounded-[2.5rem] shadow-2xl shadow-red-500/10 border border-white/50 relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 mt-2 font-medium">Bergabung dengan Telyummy - kantin Telyu</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" required class="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all shadow-sm" placeholder="Masukkan nama lengkap Anda">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-600 mb-2 ml-1">Email</label>
                        <input type="email" name="email" required class="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all shadow-sm" placeholder="Masukkan alamat email Anda">
                    </div>
                </div>
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input :type="show ? 'text' : 'password'" name="password" required 
                                class="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all shadow-sm pr-12" 
                ...
                <div x-show="role === 'penjual'" x-transition class="space-y-4 p-5 bg-red-50/30 border border-red-100 rounded-3xl">
                    <div>
                        ...
                        <input type="text" name="canteen_name" :required="role === 'penjual'" class="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all shadow-sm" placeholder="Masukkan nama kantin Anda">
                    </div>
